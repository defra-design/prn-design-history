...
declare namespace __React {
    ...
    interface CSSProperties {
        ...
        /**
         * Defines the alpha channel threshold used to extract a shape from an image. Can be through of as a "minimum opacity" threshold; that is, a value of 0.5 means that the shape will enclose all the pixels that are more than 50% opaque.
         */
